...
public class ParteArbolAfectadaDTO {
    private UUID id;
    private String nombre;
    private String descripcion;

    private ParteArbolAfectadaDTO(Builder builder) {
        setId(id);
        setNombre(nombre);
    ...
    public static class Builder {
        ...
        public ParteArbolAfectadaDTO build() {
            return new ParteArbolAfectadaDTO(this);
        }
    }
}
