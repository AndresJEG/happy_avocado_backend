...
public class ParteArbolAfectadaDominio {
    private UUID id;
    private String nombre;
    private String descripcion;

    private ParteArbolAfectadaDominio(Builder builder) {
        setId(id);
        setNombre(nombre);
    ...
    public static class Builder {
        ...
        public ParteArbolAfectadaDominio build() {
            return new ParteArbolAfectadaDominio(this);
        }
    }
}
