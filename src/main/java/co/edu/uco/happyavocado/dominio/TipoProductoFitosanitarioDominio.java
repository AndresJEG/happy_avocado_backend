...
public class TipoProductoFitosanitarioDominio{
    private UUID id;
    private String nombre;
    private String descripcion;

    private TipoProductoFitosanitarioDominio(Builder builder) {
        setId(id);
        setNombre(nombre);
    ...
    public static class Builder {
        ...
        public TipoProductoFitosanitarioDominio build() {
            return new TipoProductoFitosanitarioDominio(this);
        }
    }
}
