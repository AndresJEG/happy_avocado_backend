...
public class ParteArbolAfectadaEntidad {
    private UUID id;
    private String nombre;
    private String descripcion;

    private ParteArbolAfectadaEntidad(Builder builder) {
        setId(id);
        setNombre(nombre);
    ...
    public static class Builder {
        ...
        public ParteArbolAfectadaEntidad build() {
            return new ParteArbolAfectadaEntidad(this);
        }
    }
}
